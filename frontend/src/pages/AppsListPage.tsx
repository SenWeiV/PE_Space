...
function AppCard({
  ...
  const handleCardClick = () => {
    if (isRunning && app.access_url) {
      ...
      const url = app.access_url + sep + "pe_user=" + encodeURIComponent(uname);
      // 记录一次访问
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
              ...
              {detailApp.status === "running" && detailApp.access_url && (
                <div style={{ display: "flex", gap: 12 }}>
                  ...
                  <a href={detailApp.access_url + "?pe_user=" + encodeURIComponent(user?.username || "")} target="_blank" rel="noreferrer">
